...
pop = generate_population.generate_cells(N=N, N_inputs=N_inputs, N_layers=N_layers, N_terms=N_terms, layered=layered, amplify_inputs = amplify_inputs)
            ...
            for j in range(N):
                ...
                if action:
                    if len(action) == 2:
                        ...
                        generate_population.apoptosis(pop, i, j, N_inputs, N_layers, N_terms, ordered_crossover=ordered_crossover, amplify_inputs=amplify_inputs)                        
