...
observables_local =  ["fitness","apoptosis","y"]#, "fitness", "apoptosis"] ["in_1_NO", "in_1_YES", "in_2_NO", "in_2_YES"]
...
amplify_inputs = True # if inputs should be amplified
...
"""
"""
plasmids = [(["NOT(in_1)", "YES(in_2)"], "y", "AND"),
            (["YES(in_1)", "NOT(in_2)"], "y", "AND")]
"""



functions = {}
pop = generate_population.generate_cells_function(N, plasmids, N_inputs, amplify_inputs)
"""
for i in range(N):
    for j in range(N):
            ...
            for j in range(N):
                ...
                if action:
                    if len(action) == 2:
                        ...
                        generate_population.apoptosis(pop, i, j, N_inputs, N_layers, N_terms, amplify_inputs=amplify_inputs)                        
